...
public class MyDragShadowBuilder extends View.DragShadowBuilder {
	...
	public MyDragShadowBuilder(View imageView) {
		...
		Bitmap buffer = LayerListener.getInstance().getLayerModel().getLayer(0).getImage();
	...
	public void onProvideShadowMetrics(Point size, Point touch) {
		shadowBitmap = mergeBitmaps(greyBitmap, LayerListener.getInstance().getLayerModel().getLayer(dragPosition).getImage());
